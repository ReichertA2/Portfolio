  ...
  return (
    <Box style={{ background: "#2D2F33", marginBottom: 100 }}>
      ...
      Resume
        ...
        <div className="ml-6 pl-96 ">
          <div
            // style={{ marginBottom: 100 }}
            className="w-2/3 p-3 inline-block mb-24"
          >
            ...
            >
              ...
              <AccordionDetails>
                <Typography>
                  Technologies: Python, JavaScript ES6, HTML, CSS, Object
                  Oriented Programming, Regex, Flask, React, MUI, Git/GitHub,
                  Jupyter Notebook, Node.JS, Postgres, SQL, Postman, RESTful
                  APIs, Formik, Yup
                  <ul className="custom-list p-5">
                    <li>
                      Created a full stack reading list application that allows
                      users to browse, add, and remove books from their reading
                      list utilizing API wrappers, reducer, Formik, Yup, and
                      custom react hooks.
                    </li>
                    <li>
                      Generated a web application that allows users to search by
                      city to obtain weather information by using the Open
                      Weather API with JavaScript with Axios.
                    </li>
                    <li>
                    ...
                    <li>
                      Crafted a multi-page flask application for a pokemon
                      battle that used SQL to create the user and pokemon
                      database and configured the app to include registration,
                      edit profile, and login.
                    </li>
                    <li>
                      Produced a car dealership database using ERD with
                      elephantSQL.
                    </li>
                    <li>
                      Programmed a BlackJack game with Python OOP (Object
                      Oriented Programming) in Visual Studio Code.
                    </li>
                  </ul>
                </Typography>
              </AccordionDetails>
              ...
              <AccordionDetails>
                <Typography>
                  <ul className="custom-list p-5">
                    ...
                    <li>
                      Create targets and release limits on limiting properties
                      for Diesel and Mogas to mitigate quality disputes.
                    </li>
                    <li>
            ...
            >
              ...
              <AccordionDetails>
                <Typography>
                  ...
                  <ul className="custom-list p-5">
                    <li>
                      Led the Proficiency Testing Program (PTP) where samples
                      are logged in, distributed to designated labs, data
                      reported to PTP program (ASTM, NEG, Texas Regional), and
                      reports submitted to the lab.
                    </li>
                    <li>
                      Constructed, monitored, and maintained limits and trends
                      on 199 SQC charts as needed.
                    </li>
                  </ul>
                </Typography>
              </AccordionDetails>
            ...
            >
              ...
              <AccordionDetails>
                <Typography>
                  <ul className="custom-list p-5">
                    <li>
                      Managed 10 full slates of testing daily, assigned
                      workload, and coordinated with sampler to obtain material.
                    </li>
                    <li>
